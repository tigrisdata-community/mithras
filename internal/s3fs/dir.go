...
func (d *dir) readNext() error {
	...
	for _, o := range out.Contents {
		...
		// Skip zero-byte directory markers written by MkdirAll
		// (keys ending in "/"); the prefix they describe is already
		// surfaced via CommonPrefixes once any real file lives under
		// it, and for an otherwise-empty directory we don't want the
		// marker itself appearing as a file entry.
